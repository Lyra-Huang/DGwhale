...
```{r}
glm <- glm(data=nw,whale_presence~chl_large+chl_small+mean_sst,family='binomial',weights = nw$record_total_hrs)
summary(glm)

glm <- glm(data=nw,whale_presence~chl_large,family='binomial',weights = nw$record_total_hrs)
summary(glm)

glm <- glm(data=nw,whale_presence~chl_small,family='binomial',weights = nw$record_total_hrs)
summary(glm)

glm <- glm(data=nw,whale_presence~mean_sst,family='binomial',weights = nw$record_total_hrs)
summary(glm)
...
glm <- glm(data=se,whale_presence~chl_large,family='binomial',weights = se$record_total_hrs)
summary(glm)
